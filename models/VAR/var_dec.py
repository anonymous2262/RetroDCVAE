...
from models.VAR.utils import gaussian_kld, Con_Layer_Norm, VarFeedForward, FeedForwardNet, gumbel_softmax, GumbelSoftmax, LatFFN, tile
...
class TransformerDecoderLayer(nn.Module):
    ...
    def _forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask,
        ...
        # #++++++++++++++++++++
        # condition = memory_bank
        # input_norm = self.conln_1(inputs, condition)
        # #++++++++++++++++++++
        ...
        # #++++++++++++++++++++
        # query_norm = self.conln_2(query, condition)
        # #++++++++++++++++++++
...
class VariationalDecoderLayer(nn.Module):
    ...
    def _forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask,
        ...
        # query_norm = self.layer_norm_2(query)
        # query_norm = self.conln_1(query, condition)
        query_norm = self.conln_1(query, memory_bank)
        #++++++++++++++++++++TODO:replace LN2 with CLN
        mid, attns = self.context_attn(memory_bank, memory_bank, query_norm,
                                       mask=src_pad_mask,
                                       layer_cache=layer_cache,
                                       attn_type="context")
        #++++++++++++++++++++TODO:replace LN3 with CLN
        # mid_norm = self.conln_2(mid, condition)
