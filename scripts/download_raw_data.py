...
urls_fns_dict = {
    "USPTO_DIVERSE": [
        ("https://deepchemdata.s3.us-west-1.amazonaws.com/datasets/USPTO_MIT.csv", "USPTO-MIT.csv")
    ],
    "USPTO_50k": [
...
def parse_args():
    ...
    parser.add_argument("--data_name", help="data name", type=str, default="",
                        choices=["USPTO_50k", "USPTO_full", "USPTO_480k", "USPTO_STEREO", "miniMIT", "USPTO_DIVERSE"])
